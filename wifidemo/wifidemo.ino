...
const char* password = "mhackshype";

const char* host = "10.1.16.13:8000";
const char* path = "/index.html";

//const char* host = "raw.githubusercontent.com";
// find at https://raw.githubusercontent.com/mhacks/mhacks.github.io/master/ws2812-test.html
...
void loop() {
 ...
 // Serial.println(url);
  ...
  while (client.available()) {
   ...
   // Serial.println(root.containsKey("alarm"));
   // if(root.containsKey("alarm"))
   // {
   //   const char * what_we_wanted = root["alarm"];
